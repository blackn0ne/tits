...
(function ($) {
  ...
  var rdJs = {
    ...
    swiperActivation: function () {
      ...
      $(document).ready(function () {
        if (!document.querySelector(".project-slider")) return;
    ...
    wowActive: function () {
      if (!window.__siteWow) {
        window.__siteWow = new WOW();
        window.__siteWow.init();
      } else {
        window.__siteWow.sync();
      }
    },
    ...
    goTop: function () {
    if ($("#goTop[data-vue-managed]").length) {
        return;
    }

    if ($("#goTop").length) {
        var $goTop = $("#goTop");
        var $borderProgress = $("#goTop .border-progress");
        var $footer = $(".wpr-footer-area, .tf-footer");

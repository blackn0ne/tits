...
const projectImage = (index: number, bannerUrl: string | null): string => bannerUrl ?? portfolioImages[index % portfolioImages.length];
</script>
            ...
            <div class="container">
                <div class="section-inner border-1 bg-white">
                    ...
                    <div v-if="projects.length" class="site-projects-grid square-dot">
                        <article v-for="(project, index) in projects" :key="project.id" class="case-slide site-projects-grid__item">
